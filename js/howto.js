        ...
        <div class="modal-content" style="width: 65rem;">
            ...
            <div class="howto-section">
                ...
                <ul>
                    ...
                    <li><span><strong>Saving & Loading:</strong> Use <strong>Save</strong> to store your workspace to local storage or as a <code class="howto-code">.svs</code> file. Use <strong>Open</strong> to load a patch into a new tab. For single-workspace patches, <strong>Add In</strong> merges nodes into your current workspace.</span></li>
